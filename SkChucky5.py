...
ks = LINETCR.LINE()
#ks.login(qr=True)
ks.login(token='TOKEN_KAMU_DISINI_BEIB')
ks.loginResult()
    ...
    try:
	 ...
	 if wait["Ghost"] == True:
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to,"ĸнυѕυѕ вaιм")
...
#		    cl.sendText(msg.to,"ĸнυѕυѕ вaιм")
                ...
                wait["Sider"] = True
                cl.sendText(msg.to,"AWAS ŦERCIÐUҞ")
                ...
                if msg.to in cctv['point']:
                    ...
                    cl.sendText(msg.to, "SIÐER SUÐAħ ㊉₣₣")                         


            elif msg.text in ["Status"]:
                md = ""
		if wait["Sambutan"] == True: md+="╠➩✔️ Sαмвυтαη : Oη\n"
		else:md+="╠➩❌ ѕαмвυтαη ¤ff\n"
		if wait["joinkick"] == True: md+="╠➩✔️ Join Kick : Oη\n"
		else:md+="╠➩❌ Join Kick : ¤ff\n"		
		if wait["AutoJoin"] == True: md+="╠➩✔️ Auto Join : Oη\n"
                else: md +="╠➩❌ Auto Join : ¤ff\n"
		if wait["AutoJoinCancel"] == True: md+="╠➩✔️ Auto Join Cancel : Oη\n"
                else: md +="╠➩❌ Auto Join Cancel : ¤ff\n"                
		if wait["Leave"] == True: md+="╠➩✔️ Leave : Oη\n"
                else: md +="╠➩❌ Leave : ¤ff\n"                
		if wait["Contact"] == True: md+="╠➩✔️ Info Contact : Oη\n"
		else: md+="╠➩❌ Info Contact : ¤ff\n"
                if wait["AutoCancelon"] == True:md+="╠➩✔️ Auto Cancel : Oη\n"
                else: md+= "╠➩❌ Auto Cancel : ¤ff\n"
                if wait["inviteprotect"] == True:md+="╠➩✔️ Invite Protect : Oη\n"
                else: md+= "╠➩❌ Invite Protect : ¤ff\n"                
		if wait["Qron"] == True: md+="╠➩✔️ Qr Protect : Oη\n"
		else:md+="╠➩❌ Qr Protect : ¤ff\n"
		if wait["AutoKickon"] == True: md+="╠➩✔️ Auto Kick : Oη\n"
		else:md+="╠➩❌ Auto Kick : ¤ff\n"
		if wait["Ghost"] == True: md+="╠➩✔️ Ghost : Oη\n"
		else:md+="╠➩❌ Ghost : ¤ff\n"
		if wait["alwaysRead"] == True: md+="╠➩✔️ Always Read : Oη\n"
		else:md+="╠➩❌ Always Read: ¤ff\n"
		if wait["detectMention"] == True: md+="╠➩✔️ Auto Respon : Oη\n"
		else:md+="╠➩❌ Auto Respon : ¤ff\n"		
		if wait["kickMention"] == True: md+="╠➩✔️ Auto Respon Kick : Oη\n"
		else:md+="╠➩❌ Auto Respon Kick : ¤ff\n"				
		if wait["Sider"] == True: md+="╠➩✔️ Auto Sider : Oη\n"
		else:md+="╠➩❌ Auto Sider: ¤ff\n"	
		if wait["Simi"] == True: md+="╠➩✔️ Simisimi : Oη\n"
		else:md+="╠➩❌ Simisimi: ¤ff\n"		
                cl.sendText(msg.to,"╔═════════════════════════\n""║           ☆☞ S T A T U S ☜☆\n""╠═════════════════════════\n"+md+"╚═════════════════════════")
